...
var AI = function AI(level) {
  ...
  */
  function minimaxValue(state) {
    ...
    var stateScore = void 0; // this stores the minimax value we'll compute
  ...
  */
  ...
  undefined.plays = function (_game) {
    game = _game;
  };
  ...
  * @param turn [String]: the player to play, either X or O
  */
  undefined.notify = function (turn) {
    switch (levelOfIntelligence) {
      ...
      default:
        throw Error(levelOfIntelligence + ' invalid value for Level of Intelligence');
    }
  };
};
